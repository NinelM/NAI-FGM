...
def graph(x, y, i, x_max, x_min, grad):
    ...
    with slim.arg_scope(inception_v4.inception_v4_arg_scope()):
        logits_v4_2, end_points_v4 = inception_v4.inception_v4(
            x_nes_2, num_classes=num_classes, is_training=False, reuse=tf.AUTO_REUSE)
    cross_entropy_2 = tf.losses.softmax_cross_entropy(one_hot, logits_v4_2)
    ...
    with slim.arg_scope(inception_v4.inception_v4_arg_scope()):
        logits_v4_4, end_points_v4 = inception_v4.inception_v4(
            x_nes_4, num_classes=num_classes, is_training=False, reuse=tf.AUTO_REUSE)
    cross_entropy_4 = tf.losses.softmax_cross_entropy(one_hot, logits_v4_4)
    ...
    with slim.arg_scope(inception_v4.inception_v4_arg_scope()):
        logits_v4_8, end_points_v4 = inception_v4.inception_v4(
            x_nes_8, num_classes=num_classes, is_training=False, reuse=tf.AUTO_REUSE)
    cross_entropy_8 = tf.losses.softmax_cross_entropy(one_hot, logits_v4_8)
    ...
    with slim.arg_scope(inception_v4.inception_v4_arg_scope()):
        logits_v4_16, end_points_v4 = inception_v4.inception_v4(
            x_nes_16, num_classes=num_classes, is_training=False, reuse=tf.AUTO_REUSE)
    cross_entropy_16 = tf.losses.softmax_cross_entropy(one_hot, logits_v4_16)
