...
def graph(x, y, i, x_max, x_min, grad, mt, vt):
    ...
    with slim.arg_scope(inception_resnet_v2.inception_resnet_v2_arg_scope()):
        logits_res_v2_2, end_points_res_v2 = inception_resnet_v2.inception_resnet_v2(
            x_nes_2, num_classes=num_classes, is_training=False, reuse=tf.AUTO_REUSE)
    cross_entropy_2 = tf.losses.softmax_cross_entropy(one_hot, logits_res_v2_2)
    ...
    with slim.arg_scope(inception_resnet_v2.inception_resnet_v2_arg_scope()):
        logits_res_v2_4, end_points_res_v2 = inception_resnet_v2.inception_resnet_v2(
            x_nes_4, num_classes=num_classes, is_training=False, reuse=tf.AUTO_REUSE)
    cross_entropy_4 = tf.losses.softmax_cross_entropy(one_hot, logits_res_v2_4)
    ...
    with slim.arg_scope(inception_resnet_v2.inception_resnet_v2_arg_scope()):
        logits_res_v2_8, end_points_res_v2 = inception_resnet_v2.inception_resnet_v2(
            x_nes_8, num_classes=num_classes, is_training=False, reuse=tf.AUTO_REUSE)
    cross_entropy_8 = tf.losses.softmax_cross_entropy(one_hot, logits_res_v2_8)
    ...
    with slim.arg_scope(inception_resnet_v2.inception_resnet_v2_arg_scope()):
        logits_res_v2_16, end_points_res_v2 = inception_resnet_v2.inception_resnet_v2(
            x_nes_16, num_classes=num_classes, is_training=False, reuse=tf.AUTO_REUSE)
    cross_entropy_16 = tf.losses.softmax_cross_entropy(one_hot, logits_res_v2_16)
